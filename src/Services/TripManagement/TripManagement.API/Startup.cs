...
namespace TripManagement.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ITripContext, TripContext>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Trip Management API");
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddEntityFrameworkSqlServer()
                   .AddDbContext<TripContext>(options =>
                   {
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Online Travel Management System - Trip Management HTTP API",
                    Version = "v1",
                    Description = "The Trip Management Microservice HTTP API. This is a Data-Driven/CRUD microservice for Online Travel Management System",
