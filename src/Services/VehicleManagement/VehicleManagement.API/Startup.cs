...
using VehicleManagement.API.Filters;
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Online Travel Management System - Vehicle Management HTTP API",
                    Version = "v1",
                    Description = "The Vehicle Management Microservice HTTP API. This is a Data-Driven/CRUD microservice for Online Travel Management System",
