    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Online Travel Management System - Authentication HTTP API",
                    Version = "v1",
                    Description = "The Auth Management Microservice HTTP API. This is a Data-Driven/CRUD microservice for Online Travel Management System",
